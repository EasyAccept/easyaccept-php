...
/**
 * This class provides an empty implementation of {@see EasyScriptVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class EasyScriptBaseVisitor extends AbstractParseTreeVisitor implements EasyScriptVisitor
{
	/**
	 * {@inheritdoc}
	 *
